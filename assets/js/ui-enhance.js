(function () {
  ...
  function injectOrbs() {
    ...
    wrap.id = 'bg-orbs';
    var orbData = [
      { w: 440, h: 440, top: '-100px', left: '58%',  color: '#8C1515', dur: '28s', delay: '0s',    op: 0.18 },
      { w: 310, h: 310, top: '58%',   left: '-70px', color: '#B1040E', dur: '22s', delay: '-8s',   op: 0.14 },
      { w: 270, h: 270, top: '28%',   left: '72%',   color: '#C2453B', dur: '19s', delay: '-14s',  op: 0.12 },
      { w: 360, h: 360, top: '78%',   left: '42%',   color: '#D23B3B', dur: '34s', delay: '-5s',   op: 0.10 },
    ];
